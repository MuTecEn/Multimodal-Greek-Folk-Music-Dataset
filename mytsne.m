...
% When the number of observations is small, there is a chance that the loss
% could be marginally negative. Warn the user and recommend changing the
% LearnRate for better convergence
if loss < 0
    warning(message('stats:tsne:NegativeLoss'));
end
end
